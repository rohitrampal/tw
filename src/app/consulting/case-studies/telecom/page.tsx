      ...
      <section className="section-padding bg-gradient-to-br from-navy-500 to-teal-600 text-white">
        <div className="container-custom">
          <div className="max-w-3xl">
            <h1 className="heading-hero mb-6 text-white">Telecom Transformation</h1>
            <p className="body-large text-gray-100 mb-8">
              3x Capacity Increase, Customer Churn ↓ 21%
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom max-w-4xl">
          <div className="card mb-8">
            ...
            <ul className="space-y-2">
              {[
                'Slow customer onboarding process (5-7 days)',
                'Bottlenecks in approval workflows',
                'High customer churn due to delays',
                'Limited capacity for new customers',
              ].map((item, i) => (
          ...
          <div className="card mb-8 bg-navy-500 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { metric: 'Capacity', before: 'Baseline', after: '3x increase', improvement: '300% improvement' },
                { metric: 'Customer Churn', before: 'High', after: '↓ 21%', improvement: 'Significant reduction' },
                { metric: 'Onboarding Time', before: '5-7 days', after: '1-2 days', improvement: '70% faster' },
                { metric: 'Customer Satisfaction', before: 'Baseline', after: '+35%', improvement: 'NPS improvement' },
              ].map((result, i) => (
